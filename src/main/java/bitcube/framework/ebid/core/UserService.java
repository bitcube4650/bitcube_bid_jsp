...
//	private final String profile = System.getProperty("spring.profiles.active");
	...
	public ResponseEntity<AuthToken> login(Map<String, Object> params, HttpSession session, HttpServletRequest request) {
		try {
			...
			userDto.setLoginPw(CommonUtils.getString(params.get("loginPw")));
			String loginId = CommonUtils.getString(params.get("loginId"));
			String loginPw = CommonUtils.getString(params.get("loginPw"));
			String loginToken = "";
...
//	}
	...
	public UserDto findUser(String loginId) throws Exception {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("loginId", loginId);
		
		UserDto data = (UserDto) generalDao.selectGernalObject(DB.QRY_SELECT_FIND_USER, params);
		return data;
	}
